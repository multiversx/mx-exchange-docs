...
You can see the chosen swap route on the bottom of the swap page by clicking on “Show detailed breakdown”.

<div style={{ textAlign: 'center' }}>
    <img src="/docs/how-to/autorouter.png" width="525" alt="Smart Swaps" />
</div>

For simplicity, the example above illustrates a trade going over just two hops. However, the Autorouter is capable of determining the most efficient swap path over multiple hops.
