...
Unlike traditional staking in [liquidity pools](/products/liquidity) or [farms](/products/farms) that require pairing assets, Staking simplifies the process—allowing you to stake one token and earn rewards effortlessly in the same token.

Unstaking tokens is subject to a 10-days unbonding period. At the end of this period, a 2nd on-chain transaction will be required, for claiming the tokens back into your wallet.
