...
export const SectionCard = ({
  ...
  return (
    <Link
      to={link}
      className={clsx(
        "flex grow h-full p-6 rounded-3xl justify-between items-end hover:no-underline bg-neutral-25 dark:bg-neutral-850/50 outline outline-0 dark:outline-neutral-850/50 outline-neutral-25 hover:outline-8 transition-all ease-in-ou hover:cursor-pointer",
        className
      )}
    >
